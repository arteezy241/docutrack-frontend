                            ...
                            <div style={{ padding: '20px' }}>
                                ...
                                <form onSubmit={handleLogin}>
                                    ...
                                    <div style={{ marginBottom: 14 }}>
                                        <label style={{ display: 'block', fontSize: 11, fontWeight: 700, textTransform: 'uppercase', color: 'rgba(255,255,255,0.4)', marginBottom: 6, letterSpacing: 0.8 }}>Password</label>
                                        <input
                                            className="login-input"
                                            type="password"
                                            value={password}
                                ...
                                <div style={{ textAlign: 'center', marginTop: 12 }}>
                                    <a href="#" style={{ color: 'rgba(71,191,255,0.7)', fontSize: 12, textDecoration: 'none' }}>I can't sign in</a>
                                </div>
                    ...
                    <div style={{ width: '100%', maxWidth: 380, background: 'rgba(23,26,33,0.95)', border: '1px solid rgba(255,255,255,0.12)', borderRadius: 20, overflow: 'hidden', boxShadow: '0 24px 48px rgba(0,0,0,0.6)', animation: 'fadeUp 0.25s ease' }}>
                        ...
                        <div style={{ padding: 20 }}>
                            ...
                            <button
                                ...
                                style={{ opacity: deviceOtpLoading || deviceOtp.length < 6 ? 0.5 : 1 }}
                            >
                                {deviceOtpLoading ? 'Verifying...' : 'Verify Device'}
                            </button>
                            <div style={{ textAlign: 'center', marginTop: 12 }}>
                                <button
                                    onClick={() => { setShowDeviceOtp(false); setDeviceOtp(''); setDeviceOtpError(''); setTrustDevice(false); }}
                                    style={{ background: 'none', border: 'none', color: 'rgba(71,191,255,0.7)', fontSize: 12, cursor: 'pointer', fontFamily: "'Inter', sans-serif" }}
                                >
                                    Cancel
                                </button>
                            </div>
